...
with open('patchlist.json', 'w') as data_to_write_to_json: # тут указываем, как назвать документ для записи и его формат
    data_writing = json.dump(data_for_json.__dict__, data_to_write_to_json, sort_keys=True, indent=4) # собственно, записываем